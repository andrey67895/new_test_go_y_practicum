...
func GetRoutersForServer(iStorage storage.IStorageData) *chi.Mux {
	...
	r.Use(middleware.RealIP, handlers.WithLogging, middleware.Recoverer, handlers.GzipHandleResponse, handlers.WithSendsGzip, handlers.CheckHeaderCrypto, handlers.WithCrypto)
